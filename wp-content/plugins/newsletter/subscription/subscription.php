...
class NewsletterSubscription extends NewsletterModule {
    ...
    function get_subscription_form($referrer = null, $action = null, $attrs = array()) {
        ...
        $buffer .= '<div class="newsletter newsletter-subscription"><div class="wrapper"><h1 class="newsletter_title">Ready for Sleep?<br>
                <span>Get your free guide to successful sleep here</span></h1><div class="newsletter_form">' . "\n";
        if (empty($action)) {
        ...
        if ($options_profile['name_status'] == 2) {
            $buffer .= "<!-- first name -->\n";
            $buffer .= "<tr>\n\t" . '<th></th>' . "\n\t" . '<td><input class="newsletter-firstname" placeholder="' . $options_profile['name'] . '" type="text" name="nn" size="30"' . ($options_profile['name_rules'] == 1 ? 'required' : '') . '></td>' . "\n" . '</tr>' . "\n\n";
        }
        ...
        $buffer .= "<!-- email -->\n";
        $buffer .= "<tr>\n\t" . '<th></th>' . "\n\t" . '<td align="left"><input class="newsletter-email" placeholder="' . $options_profile['email'] . '" type="email" name="ne" size="30" required></td>' . "\n" . '</tr>' . "\n\n";

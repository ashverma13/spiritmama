...
if ( $has_image )
{ 
	echo "	<div class=\"wrapper\"><div class=\"table\"><div class=\"table-cell\"><div class=\"testimonial_rotator_img testimonial_img img\">" . get_the_post_thumbnail( get_the_ID(), $img_size) . "</div></div>\n"; 
}

// DESCRIPTION
echo "	<div class=\"table-cell\"><div class=\"text testimonial_rotator_description testimonial_text\">\n";
...
echo "	<a>Read More</a></div></div></div></div>\n";
